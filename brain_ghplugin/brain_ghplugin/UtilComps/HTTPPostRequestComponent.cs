    ...
    public class HTTPPostRequestComponent : GH_Component
    {
        ...
        public HTTPPostRequestComponent()
          : base("HTTPPostRequestComponent", "POST",
              "Create a generic HTTP POST request (synchronous)",
              "Brain", "Utils")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            try
            {
                ...
                response = new System.IO.StreamReader(res.GetResponseStream()).ReadToEnd();
            }
        ...
        {
            get { return new Guid("1D2AE06F-FE7D-46F1-B462-ABA73378C343"); }
        }
    }
} 